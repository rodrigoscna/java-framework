package br.com.arauk.ark.activesupport.core_ext;

import java.util.Collection;
import java.util.Iterator;

import br.com.arauk.ark.activesupport.Inflector;
...
public class StringUtils {
     ...
     * @see br.com.arauk.ark.activesupport.Inflector#constantize(String)
     */
     ...
     * @param camelizedWord The camel case term that references the class.
     * @return A Class as specified in the string.
     * @see br.com.arauk.ark.activesupport.Inflector#safeConstantize(String)
     */
