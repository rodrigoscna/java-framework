...
import co.atlas_tech.atlasandroid.activesupport.Inflector;
...
public class StringUtils {
     ...
     * StringUtils.camelize("atlasandroid/activerecord/errors") == "atlasandroid.activerecord.Errors"
     * StringUtils.camelize("atlasandroid/activerecord/errors", "lower") == "atlasandroid.activerecord.errors"
     * }</pre>
     *
    ...
    /**
     * Creates a class name from a plural table name like Atlas does for table
     ...
     * @see co.atlas_tech.atlasandroid.activesupport.Inflector#constantize(String)
     */
     ...
     * @param camelizedWord The camel case term that references the class.
     * @return A Class as specified in the string.
     * @see co.atlas_tech.atlasandroid.activesupport.Inflector#safeConstantize(String)
     */
    ...
    /**
     * Creates the name of a table like Atlas does for models to table names.
     ...
     * StringUtils.underscore("atlasandroid.activerecord.Errors") == "atlasandroid/activerecord/errors"
     * }</pre>
     *
